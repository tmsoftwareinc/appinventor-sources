...
goog.provide('AI.Blockly.Msg.ja_jp');
...
Blockly.Msg.ja.switch_language_to_japanese = {
...
// Context menus.
    ...
    Blockly.Msg.DELETE_BLOCK = 'ブロック削除';
    ...
    Blockly.Msg.BACKPACK_CONFIRM_EMPTY = '本当にバックパックを空にして良いですか?';
...
// Colour Blocks.
    ...
    Blockly.Msg.LANG_COLOUR_YELLOW = '黄';
    ...
    Blockly.Msg.LANG_COLOUR_GRAY = 'グレー';
    ...
    Blockly.Msg.LANG_COLOUR_MAKE_COLOUR = 'RGBでカスタム色作成';
...
// Math Blocks.
    ...
    Blockly.Msg.LANG_MATH_DIVIDE_OPERATOR_MODULO = 'mod';
...
// Text Blocks.
    ...
    Blockly.Msg.LANG_TEXT_CONTAINS_INPUT = 'テキスト内に部分テキストがあるか?  テキスト %1 部分テキスト %2';
...
//Blockly.Msg.LANG_LISTS_CREATE_EMPTY_TOOLTIP = 'Returns a list, of length 0, containing no data records';
    ...
    Blockly.Msg.LANG_LISTS_REVERSE_TITLE_REVERSE = 'リストを逆転';
...
// Procedures Blocks.
    ...
    Blockly.Msg.LANG_PROCEDURES_DEFNORETURN_PROCEDURE = '手続き';
    ...
    Blockly.Msg.LANG_PROCEDURES_DOTHENRETURN_THEN_RETURN = 'リターン';
    Blockly.Msg.LANG_PROCEDURES_DOTHENRETURN_DO = '実行';
    Blockly.Msg.LANG_PROCEDURES_DOTHENRETURN_RETURN = 'リターン';
    ...
    Blockly.Msg.LANG_PROCEDURES_DEFRETURN_RETURN = 'リターン';
...
// Components Blocks.
    ...
    Blockly.Msg.LANG_COMPONENT_BLOCK_TITLE_WHEN = 'いつも ';
...
// Messages from replmgr.js
    ...
    Blockly.Msg.REPL_CONNECT_TO_COMPANION = "Companionに接続";
    ...
    Blockly.Msg.REPL_WEBRTC_CONNECTION_ERROR = "Companion接続エラー";
